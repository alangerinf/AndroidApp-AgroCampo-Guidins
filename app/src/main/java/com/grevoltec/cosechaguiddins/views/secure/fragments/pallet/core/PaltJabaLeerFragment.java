...
@EFragment(R.layout.palt_read_jaba_frag)
public class PaltJabaLeerFragment extends AbsQrFragment {
    ...
    public PaltJabaLeerFragment setOnStepChangeListener(IPaltCrear onStepChangeListener) {
