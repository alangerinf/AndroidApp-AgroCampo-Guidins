...
import com.grevoltec.cosechaguiddins.views.secure.fragments.despacho.core.DespViajeEditarFragment_;
...
public class DespViajeModificaTabFragment extends AbsFragment implements IViajeModifica {
    ...
    protected DespViajeModificaTabFragment that;

    protected String qrCamionSelected;
    protected IViajeModificaChangeListener listener;
    ...
    private void setupViewPager(final AppViewPager viewPager) {
        goToFirstStep();
        toolbar.setTitle(R.string.modificar_viaje);
        tabs.addTab(tabs.newTab().setText(R.string.viaje));
    ...
    public void validateQR(String qr) throws AppException {
        QrUtils.QR_CAMIONES.validateQR(qr);
        if(this.qrCamionSelected.compareToIgnoreCase(qr) == 0) throw new AppException(getString(R.string.qr_debe_ser_diferente));
    }
    ...
    @Override
    public String getQrCamionViaje() {
        return this.qrCamionSelected;
    }

    @Override
    public void setListener(IViajeModificaChangeListener listener) {
    ...
    public class PagerAdapter extends AbsPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    return new DespViajeSelectFragment_().setType(DespViajeSelectFragment.TYPE_EDIT_PALLET).setListenerModifica(that);
                case 1:
                    return new DespViajeEditarFragment_().setOnStepChangeListener(that);
                default:
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case 0:
                    return getString(R.string.viajes);
                case 1:
