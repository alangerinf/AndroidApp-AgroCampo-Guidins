...
import com.grevoltec.cosecha.views.secure.fragments.despacho.pallet.DespPalletLeerFragment_;
import com.grevoltec.cosecha.views.secure.fragments.despacho.pallet.DespViajeResumenFragment_;
import com.grevoltec.cosecha.views.secure.fragments.despacho.viaje.DespViajeCrearFragment_;
...
public class DespViajeCrearTabFragment extends AbsFragment implements IViajeCrear {
    ...
    protected DespViajeCrearTabFragment that;
    ...
    private void setupViewPager(final AppViewPager viewPager) {
        goToFirstStep();
        toolbar.setTitle(R.string.crear_viaje);
    ...
    public void validateQRPallete(String qr) throws AppException {
        ...
        for (ViajeEntity entity: items) {
            if(qr.equalsIgnoreCase(entity.getQrpallet())) throw new AppException(getString(R.string.qr_pallet_ya_leido));
        }
    }
    ...
    public class PagerAdapter extends AbsPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    return new DespViajeCrearFragment_().setOnStepChangeListener(that);
                case 1:
                    return new DespPalletLeerFragment_().setOnStepChangeListener(that);
                case 2:
